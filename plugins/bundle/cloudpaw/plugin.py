...
def _ensure_default_env_vars() -> None:
    """Ensure required env var keys always appear in the gepaw console.
    ...
    try:
        ...
        logger.warning("Cannot import gepaw.envs; env provisioning skipped")
        return
...
def _register_a2a_command() -> None:
    ...
    try:
        from gepaw.app.runner.control_commands import register_command
...
def _patch_plugin_loader_unload() -> None:
    ...
    """
    try:
        from gepaw.plugins.loader import PluginLoader
    except ImportError:
        logger.warning(
