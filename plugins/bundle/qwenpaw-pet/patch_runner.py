# -*- coding: utf-8 -*-
"""Patch gepaw AgentRunner from inside the backend plugin."""
...
def _request_meta(runner: Any, request: Any) -> dict[str, Any]:
    return {
        ...
        "agent_name": getattr(runner, "agent_name", "gepaw"),
...
def patch_agent_runner() -> None:
    ...
    _PATCHED = True
    logger.info("gepaw Pet patched AgentRunner.query_handler")
...
def restore_agent_runner() -> None:
    ...
    _PATCHED = False
    logger.info("gepaw Pet restored AgentRunner.query_handler")
