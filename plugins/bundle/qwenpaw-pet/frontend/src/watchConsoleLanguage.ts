/** gepaw console stores UI language in ``localStorage.language``. */

const LANGUAGE_KEY = "language";
const LANGUAGE_EVENT = "gepaw-pet-language-change";
...
function installLanguageSetItemHook(): void {
  const marker = "__gepawPetLanguageHook";
...
/** Subscribe to gepaw header language switcher (no console changes needed). */
