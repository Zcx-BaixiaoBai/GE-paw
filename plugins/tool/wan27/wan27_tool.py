...
from gepaw.constant import DEFAULT_MEDIA_DIR
from gepaw.plugins import get_tool_config
...
async def reference_to_video_wan(
    ...
    images as "?", "?", etc. and reference videos as "1",
    "2", etc. (or "Image 1", "Video 1" in English prompts).

    Args:
        prompt (str):
            Text description of the video. Use "?", "?" to
            refer to reference images, "1", "2" to refer
