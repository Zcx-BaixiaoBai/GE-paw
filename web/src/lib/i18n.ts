...
export const dict = {
  ...
  "plan.empty.hint": "开始一段新会话，助手会在合适的时机提出可验证的计划步骤",
  ...
  "chat.permission.suffix": "权限：{mode}",
  ...
  // QnA page
  "qna.badge": "知识库",
  "qna.placeholder": "基于知识库提问…",
  "qna.ask": "提问",
  "qna.asking": "检索中…",
  "qna.empty.answer": "暂无答案",
  "qna.citations": "引用来源",
  "qna.recent": "近期问题",
  "qna.openInFiles": "在右侧面板打开",
  "qna.intro": "输入问题后从知识库检索相关答案",
    "qna.score": "分数 {score}",
