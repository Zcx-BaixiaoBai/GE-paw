...
export type TabKind = "files" | "web" | "diff" | "preview" | "plan" | "goals" | "progress";
...
export const TabRegistry: Record<TabKind, TabMeta> = {
  ...
  progress: { title: t("tab.progress") || "进度", icon: <IconList size={14} />, component: ProgressTab, available: true, hint: "查看任务执行的步骤进度" },
};

export const AllTabKinds: TabKind[] = ["files", "web", "diff", "preview", "plan", "goals", "progress"];
