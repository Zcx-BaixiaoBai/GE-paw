...
class SecurityPage(BasePage):
    ...
    # Tabs
    TOOL_GUARD_TAB = '[data-node-key="toolGuard"] .gepaw-tabs-tab-btn'
    FILE_GUARD_TAB = '[data-node-key="fileGuard"] .gepaw-tabs-tab-btn'

    # Active panel
    ACTIVE_PANEL = '.gepaw-tabs-tabpane-active'

    # Guard switch
    GUARD_SWITCH = 'button.gepaw-switch[role="switch"]'

    # Save button
    SAVE_BTN = 'button.gepaw-btn-primary:has-text(""), button:has-text("??)'

    # Protected tools select
    PROTECTED_TOOLS_SELECT = '.gepaw-select'

    # File guard path input
    PATH_INPUT = 'input[placeholder*="?]'
