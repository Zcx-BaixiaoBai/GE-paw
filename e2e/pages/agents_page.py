# -*- coding: utf-8 -*-
"""
gepaw Agents management page object.
...
class AgentsPage(BasePage):
    ...
    PAGE_HEADER = 'button:has-text("Create Agent"), span[class*="breadcrumbCurrent"]:has-text("?)'
    BREADCRUMB = 'span[class*="breadcrumbCurrent"]:has-text("?)'

    # Agent list (table structure)
    AGENT_TABLE = '.gepaw-table'
    AGENT_LIST = '.gepaw-table-tbody'
    AGENT_ITEM = '.gepaw-table-tbody tr.gepaw-table-row'
    # Table column order: drag handle (1) | Name (2) | ID (3) | Description (4) | Workspace (5) | Model (6) | Actions (7)
    AGENT_NAME_CELL = 'td.gepaw-table-cell:nth-child(2)'
    AGENT_ID_CELL = 'td.gepaw-table-cell:nth-child(3)'
    AGENT_DESC_CELL = 'td.gepaw-table-cell:nth-child(4)'
    AGENT_WORKSPACE_CELL = 'td.gepaw-table-cell:nth-child(5)'
    AGENT_MODEL_CELL = 'td.gepaw-table-cell:nth-child(6)'
    AGENT_ACTIONS_CELL = 'td.gepaw-table-cell:nth-child(7)'
    AGENT_STATUS = '.gepaw-tag'

    # Action buttons
    CREATE_AGENT_BTN = 'button:has-text("?), button:has-text("Create Agent"), .gepaw-btn-primary'
    ...
    EDIT_BTN = 'button:has(.anticon-edit), .gepaw-space-item:nth-child(1) button'
    TOGGLE_BTN = '.gepaw-space-item:nth-child(2) button'
    DELETE_BTN = 'button.gepaw-btn-dangerous, button:has(.anticon-delete)'
    ENABLE_TOGGLE = '.gepaw-space-item:nth-child(2) button'
    REFRESH_BTN = 'button:has(.anticon-reload), button:has(.spark-icon-spark-refresh-line)'

    # Create/edit form
    FORM_DIALOG = '.gepaw-modal, [role="dialog"]'
    FORM_TITLE = '.gepaw-modal-header-title, .gepaw-spark-title'
    ...
    FORM_SKILLS_SELECT = '.gepaw-form-item:has-text("Skills") .gepaw-select-selector'
    FORM_SUBMIT_BTN = '.gepaw-modal-footer button.gepaw-btn-primary, button:has-text(""), button:has-text("Save")'
    FORM_CANCEL_BTN = '.gepaw-modal-footer button.gepaw-btn-default, button:has-text(""), button:has-text("Cancel")'

    # Delete confirmation (Popconfirm bubble)
    DELETE_CONFIRM_DIALOG = '.gepaw-popconfirm'
    DELETE_CONFIRM_BTN = '.gepaw-popconfirm-buttons button.gepaw-btn-primary'
    DELETE_CANCEL_BTN = '.gepaw-popconfirm-buttons button.gepaw-btn-default'

    # Agent detail
    AGENT_DETAIL_TAB = '.gepaw-tabs-tab-btn'
    AGENT_DETAIL_PANEL = '.gepaw-tabs-tabpane-active'
    AGENT_FILES_LIST = '[class*=fileList], .gepaw-list'
    AGENT_FILE_ITEM = '[class*=fileItem], .gepaw-list-item'

    # Empty state
    EMPTY_STATE = '.gepaw-empty, [class*=empty]'
    EMPTY_STATE_TEXT = '.gepaw-empty-description, .gepaw-empty-desc'
