...
class McpPage(BasePage):
    ...
    CREATE_BTN_SELECTOR = 'button.gepaw-btn-primary:has-text("?)'
    ...
    # Create dialog
    MODAL_CONTENT_SELECTOR = '.gepaw-modal-content'
    MODAL_TITLE_SELECTOR = '.gepaw-spark-modal-title'
