...
class SessionsPage(BasePage):
    ...
    PAGE_LOAD_INDICATOR = '.ant-table, .gepaw-table, table'

    # Filter bar
    FILTER_USER_ID_INPUT = 'input[placeholder*="User ID" i], input[placeholder*="用户" i]'
    FILTER_CHANNEL_SELECT = '.ant-select[data-placeholder*="Channel" i], .gepaw-select'
    FILTER_RESET_BTN = 'button:has-text("Reset"), button:has-text("重置")'

    # Session table
    SESSION_TABLE = '.ant-table, .gepaw-table, table'
    SESSION_ROW = '.ant-table-tbody tr, .gepaw-table-tbody tr, table tbody tr'
    SESSION_TABLE_ROW = '.ant-table-tbody tr, .gepaw-table-tbody tr, table tbody tr'
    SESSION_ROW_SELECTED = '.ant-table-tbody tr.ant-table-row-selected, .gepaw-table-tbody tr.gepaw-table-row-selected'
    ...
    EDIT_BTN = (
        ...
        '.gepaw-table-cell-fix-right button:has-text("Edit"), '
        '.gepaw-table-cell-fix-right button:has-text("编辑"), '
    ...
    DELETE_BTN = (
        ...
        '.gepaw-table-cell-fix-right button:has-text("Delete"), '
        '.gepaw-table-cell-fix-right button:has-text("删除"), '
    ...
    # Edit drawer
    SESSION_DRAWER = '[class*=drawer], .ant-drawer, .gepaw-drawer'
    DRAWER_TITLE = '[class*=drawer] .ant-drawer-header-title, .ant-drawer-title, .gepaw-drawer-title'
    DRAWER_CLOSE = '.ant-drawer-close, .gepaw-drawer-close'
    ...
    FORM_CHANNEL_SELECT = '.ant-select[name="channel"], .gepaw-select[name="channel"]'
    FORM_SUBMIT_BTN = '[class*=drawer] button.ant-btn-primary, [class*=drawer] button.gepaw-btn-primary, button:has-text("Save"), button:has-text("保存")'
    FORM_CANCEL_BTN = '[class*=drawer] button:has-text("Cancel"), [class*=drawer] button:has-text("取消")'

    # Confirmation dialog
    CONFIRM_MODAL = '.ant-modal, .gepaw-modal'
    CONFIRM_OK_BTN = '.ant-modal .ant-btn-primary, .gepaw-modal .gepaw-btn-primary, button:has-text("OK"), button:has-text("确认"), button:has-text("确定")'
    CONFIRM_CANCEL_BTN = '.ant-modal .ant-btn:not(.ant-btn-primary), .gepaw-modal .gepaw-btn:not(.gepaw-btn-primary), button:has-text("Cancel"), button:has-text("取消")'
