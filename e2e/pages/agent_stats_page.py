# -*- coding: utf-8 -*-
"""
gepaw AgentStats agent statistics page object.
...
class AgentStatsPage(BasePage):
    ...
    # Date range picker
    DATE_RANGE_PICKER = ".gepaw-picker-range, .gepaw-picker"
    DATE_RANGE_INPUT = ".gepaw-picker-range input, .gepaw-picker input"
    DATE_PICKER_PANEL = ".gepaw-picker-panel, .gepaw-picker-dropdown"

    # Summary cards
    SUMMARY_CARD = '[class*="summaryCard"], [class*="SummaryCard"], .gepaw-card'
    SUMMARY_CARD_TITLE = '[class*="cardTitle"], [class*="title"], .gepaw-statistic-title'
    SUMMARY_CARD_VALUE = '[class*="cardValue"], [class*="value"], .gepaw-statistic-content-value'
    ...
    def get_card_title(self, card: Locator) -> str:
        ...
        title_el = card.locator(
            '[class*="title"], .gepaw-statistic-title, h3, h4, span'
        ).first
    ...
    def get_card_value(self, card: Locator) -> str:
        ...
        value_el = card.locator(
            '[class*="value"], .gepaw-statistic-content-value, '
