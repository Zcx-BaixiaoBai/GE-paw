# -*- coding: utf-8 -*-
"""
gepaw E2E test framework - Page Object base class.
...
class BasePage:
    ...
    SUCCESS_MESSAGE = '.ant-message-success, .gepaw-message-success, .gepaw-notification-success'
    ERROR_MESSAGE = '.ant-message-error, .gepaw-message-error, .gepaw-notification-error'
    LOADING_SPINNER = '.ant-spin, .gepaw-spin, [class*=loading]'
    ...
    def step_shot(self, action: str, full_page: bool = False) -> str:
        ...
        - The test case name is passed through page._gepaw_test_name (injected by conftest).
        ...
        try:
            ...
            test_name = getattr(self.page, "_gepaw_test_name", None) or "unknown_test"
            ...
            seq = getattr(self.page, "_gepaw_step_seq", 0) + 1
            try:
                self.page._gepaw_step_seq = seq
            except Exception:
                pass
