...
class VoicePage(BasePage):
    ...
    # Page load indicator
    PAGE_LOAD_INDICATOR = '.gepaw-switch, .gepaw-switch-input, [class*=voiceToggle]'

    # Voice service switch
    VOICE_TOGGLE_SELECTOR = '.gepaw-switch, .gepaw-switch-input, [class*=voiceToggle]'

    # Configuration form
    CONFIG_FORM_SELECTOR = '.gepaw-form, [class*=configForm], form'

    # Success message
    SUCCESS_MESSAGE_SELECTOR = '.gepaw-message-success, .gepaw-notification-success'
