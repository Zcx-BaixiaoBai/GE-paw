...
class SkillsPage(BasePage):
    ...
    # Search input
    SEARCH_INPUT = 'input[placeholder*="搜索"], input[placeholder*="Search"], .ant-input-search input, .gepaw-input-search input'
    ...
    def get_skill_name(self, card: Locator) -> str:
        ...
        title_element = card.locator('.ant-card-meta-title, .gepaw-card-meta-title, h3, h4, [class*="title"]').first
