# -*- coding: utf-8 -*-
"""
gepaw E2E Test Framework - Pytest Fixtures
...
def page(browser_context: BrowserContext, request: pytest.FixtureRequest) -> Generator[Page, None, None]:
    ...
    try:
        page._gepaw_test_name = test_name
        page._gepaw_step_seq = 0
    except Exception:
        pass
...
def authenticated_page(page: Page) -> Page:
    ...
    gepaw currently uses an auth-free mode; extend this fixture if login
    is needed.
...
def test_file(tmp_path: Path) -> Path:
    ...
    test_content = """gepaw Test File

This is a file used to verify the E2E file upload functionality.

gepaw is an intelligent assistant platform supporting the following features:
