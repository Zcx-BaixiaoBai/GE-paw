# -*- coding: utf-8 -*-
"""
gepaw Agents module P0-level end-to-end test cases.
...
class TestCreateAgent:
    ...
    def test_create_agent_success(self, page: Page, request: pytest.FixtureRequest):
        ...
        agent_description = f"_{timestamp}"
    ...
    def test_create_agent_cancel(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            agents_page.fill_agent_form("TestCancelAgent", "")
...
class TestToggleAgent:
    ...
    def test_toggle_agent_status(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            disabled_tag = page.locator(f'.gepaw-table-row:has-text("{agent_name}") .gepaw-tag:has-text("Disabled")')
            # Approach 2: check the success toast
            success_msg = page.locator('.gepaw-message-success, .gepaw-notification-success')
            ...
            agent_row = page.locator(f'.gepaw-table-row:has-text("{agent_name}")').first
            if agent_row.is_visible():
                toggle_btn = agent_row.locator('.gepaw-space-item:nth-child(2) button').first
                toggle_btn.click()
                page.wait_for_timeout(500)
                # Handle a possible confirm popover
                popconfirm_btn = page.locator('.gepaw-popconfirm-buttons button.gepaw-btn-primary').first
            ...
            disabled_tag_after = page.locator(f'.gepaw-table-row:has-text("{agent_name}") .gepaw-tag:has-text("Disabled")')
...
class TestAgentSkillAssociation:
    ...
    def test_agent_skill_association(self, page: Page, request: pytest.FixtureRequest):
        ...
        agent_cards = page.locator('.gepaw-card, [class*="agentCard"]').all()
        ...
        detail_area = page.locator(
            '.gepaw-modal, .ant-modal, .gepaw-drawer, .ant-drawer, '
        ...
        interactive_elements = page.locator(
            'input, textarea, .gepaw-switch, .gepaw-select, '
            '.gepaw-radio-group, button'
        ).all()
