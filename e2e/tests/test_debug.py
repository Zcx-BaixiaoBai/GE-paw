...
class TestDebugPageDisplay:
    ...
    def test_debug_page_load_and_display(self, page: Page, request: pytest.FixtureRequest):
        ...
        info_alert = page.locator('.gepaw-alert-info, .gepaw-alert').first
        ...
        log_card = page.locator('.gepaw-card').first
        expect(log_card).to_be_visible(timeout=5000)
        card_title = log_card.locator('.gepaw-card-head-title').first
...
class TestDebugLogControls:
    ...
    def test_debug_log_control_buttons(self, page: Page, request: pytest.FixtureRequest):
        ...
        error_alert = page.locator('.gepaw-alert-error').first
        ...
        switches = page.locator('.gepaw-card-extra .gepaw-switch, .gepaw-card-head .gepaw-switch').all()
...
class TestDebugLogLevelFilter:
    ...
    def test_debug_log_level_filter(self, page: Page, request: pytest.FixtureRequest):
        ...
        level_select = page.locator('.gepaw-select').first
        ...
        for level in expected_levels:
            option = dropdown.locator(f'.gepaw-select-item:has-text("{level}")').first
        ...
        error_option = dropdown.locator(
            '.gepaw-select-item:has-text("ERROR"), '
            '.gepaw-select-item:has(.gepaw-tag)'
        ).first
        ...
        level_select.click()
        page.wait_for_timeout(500)
        all_option = page.locator('.gepaw-select-dropdown .gepaw-select-item').first
...
class TestDebugLogSearch:
    ...
    def test_debug_log_keyword_search(self, page: Page, request: pytest.FixtureRequest):
        ...
        clear_btn = search_input.locator('..').locator('.gepaw-input-clear-icon').first
...
class TestDebugLogFileInfo:
    ...
    def test_debug_log_file_info(self, page: Page, request: pytest.FixtureRequest):
        ...
        warning_alert = page.locator('.gepaw-alert-warning').first
