# -*- coding: utf-8 -*-
"""
gepaw ACP (Agent Communication Protocol) management module end-to-end tests
    ...
    def test_acp_page_load_and_card_list(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            create_btn = page.locator(
                ...
                'button:has-text(""), button:has-text("New")'
            ).first
            ...
            cards = page.locator(
                '[class*="acpCard"], [class*="ACPCard"], .gepaw-card'
            ).all()
...
class TestCreateACPDrawerForm:
    ...
    def test_create_acp_drawer_form(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            switches = drawer.locator('.gepaw-switch').all()
            logger.info(f"Found {len(switches)} switch fields")

            # tool_parse_mode dropdown
            select_el = drawer.locator('.gepaw-select').first
            ...
            close_btn = drawer.locator('.gepaw-drawer-close, .gepaw-modal-close').first
...
class TestACPToggleSwitch:
    ...
    def test_acp_toggle_switch(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            first_card = cards[0]
            target_switch = first_card.locator('.gepaw-switch').first
    ...
    def test_filter_tabs_switch(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            builtin_tab = page.locator(
                ...
                '[class*="tab"]:has-text(""), '
                '.gepaw-segmented-item:has-text("Builtin"), '
                '.gepaw-segmented-item:has-text("")'
            ).first
            ...
            custom_tab = page.locator(
                ...
                '[class*="tab"]:has-text("?), '
                '.gepaw-segmented-item:has-text("Custom"), '
                '.gepaw-segmented-item:has-text("?)'
            ).first
            ...
            all_tab = page.locator(
                ...
                '[class*="tab"]:has-text(""), '
                '.gepaw-segmented-item:has-text("All"), '
                '.gepaw-segmented-item:has-text("")'
            ).first
    ...
    def test_edit_acp_config(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            card_body = first_card.locator(
                '[class*="cardBody"], [class*="content"], .gepaw-card-body, '
            ...
            if agent_key_input.is_visible(timeout=3000):
                ...
                drawer_title = drawer.locator('.gepaw-drawer-title').first
    ...
    def test_create_and_delete_custom_acp(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            save_btn = drawer.locator(
                'button.gepaw-btn-primary, button:has-text("Save"), '
                'button:has-text(""), button:has-text("OK"), button:has-text("")'
            ).first
            ...
            if found_new:
                ...
                target_card = page.locator(
                    ...
                    f'[class*="ACPCard"]:has-text("{created_acp_key}"), '
                    f'.gepaw-card:has-text("{created_acp_key}")'
                ).first
                ...
                if target_card.is_visible(timeout=3000):
                    ...
                    edit_drawer = page.locator(".gepaw-drawer, .gepaw-modal").first
    ...
    def test_builtin_acp_protection(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            if key_input.is_visible(timeout=3000):
                ...
                hidden_item = drawer.locator('.gepaw-form-item-hidden').first
    ...
    def test_acp_card_content_details(self, page: Page, request: pytest.FixtureRequest):
        ...
        try:
            ...
            for i, card in enumerate(cards[:4]):  # Verify up to first 4
                ...
                # Check switch exists
                switch = card.locator('.gepaw-switch').first
                if switch.count() > 0:
                    cards_with_switch += 1
