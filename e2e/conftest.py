# -*- coding: utf-8 -*-
"""
gepaw E2E Test Framework - Pytest Configuration
"""
...
# This ensures gepaw_HEADLESS correctly controls the browser display mode.
pytest_plugins = []
...
def pytest_configure(config):
    ...
    metadata['Project'] = 'gepaw E2E Automation'
...
def pytest_html_report_title(report):
    ...
    try:
        report.title = "gepaw E2E Automation Test Report"
    except Exception:
        pass
...
def pytest_html_results_summary(prefix, summary, postfix):
    ...
    prefix.extend([
        "<p>This report is auto-generated by the gepaw E2E automation framework.</p>",
