...
"""
Create a temporary conda env, install gepaw from a wheel, run conda-pack.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack gepaw (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        # Install gepaw with all dependencies
        ...
        # gepaw[full]. Restore conda-managed packaging tools before packing.
        _run(
            [
                conda,
                "run",
