...
One-click analysis of gepaw startup performance, identify bottlenecks, and provide optimization suggestions.
...
- **Import Time Analysis** - gepaw modules and third-party library import time ranking
...
2. **Data Analysis**
   - Parse log files
   - Categorize statistics (gepaw/third-party/stdlib)
...
- Python 3.8+
- No extra dependencies (except gepaw itself)
- Pure JSON data output
- HTML runs standalone, viewable offline

## Related Tools

- `src/gepaw/utils/startup_display.py` - Startup banner display
