#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for gepaw."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in gepaw package."""
...
def main():
    """Run tracer on gepaw app import."""
    ...
    tracer = ExecTracer(package_names=["gepaw"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import gepaw app to trigger startup
        from gepaw.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
