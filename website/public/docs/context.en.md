...
> The context management mechanism is inspired by [OpenClaw](https://github.com/openclaw/openclaw) and independently implemented via **LightContextManager** in gepaw.

### How It Works ?Summary

gepaw context management uses two parallel offload paths to handle the limited context window:
...
gepaw's context consists of two components:
...
- [AsMsgHandler](https://github.com/agentscope-ai/gepaw/blob/main/src/gepaw/agents/context/as_msg_handler.py) ?Context checking and message formatting
- [compactor_prompts](https://github.com/agentscope-ai/gepaw/blob/main/src/gepaw/agents/context/compactor_prompts.py) ?Compaction prompts
...
When the context approaches its limit, gepaw automatically triggers compaction, condensing old conversations into a structured summary.
...
Configuration is located in `~/.gepaw/workspaces/{agent_id}/agent.json` under `agents.running`:
