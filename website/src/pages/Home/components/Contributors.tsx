  ...
  return (
    <>
      <motion.section
        ...
        aria-labelledby="gepaw-contributors-heading"
      >
        <div className="mx-auto max-w-7xl text-center">
          <motion.h2
            id="gepaw-contributors-heading"
          ...
          <div
            className="pointer-events-none relative left-1/2 mt-10 h-px w-screen -translate-x-1/2 animate-[gepaw-dash-move-right_1s_linear_infinite]"
            style={{
              background:
          ...
          >
            ...
            <p>
              ...
              <a
                href="https://github.com/agentscope-ai/gepaw"
                target="_blank"
                rel="noopener noreferrer"
                className="text-(--color-primary) ml-1"
              >
