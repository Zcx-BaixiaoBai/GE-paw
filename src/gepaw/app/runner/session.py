...
except ImportError:  # stub fallback when agentscope.session is missing
    class SessionBase:  # type: ignore[no-redef]
        """Stub fallback for agentscope.session.SessionBase."""
        pass
