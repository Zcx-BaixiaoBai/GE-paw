...
from gepaw.plugins.validation import (
...
def _is_running() -> bool:
    ...
    """
    from ..config.utils import is_gepaw_running

    return is_gepaw_running()
...
def install(source: str, force: bool):
    ...
    Examples:
        gepaw plugin install examples/plugins/idealab-provider
