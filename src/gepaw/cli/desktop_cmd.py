# -*- coding: utf-8 -*-
"""CLI command: run gepaw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run gepaw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing gepaw app instance.
    """
    ...
    click.echo(f"Starting gepaw app on {url} (port {port})")
