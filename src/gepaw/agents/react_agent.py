...
class QwenPawAgent(CodingModeMixin, ToolGuardMixin, ReActAgent):
    ...
    def _rebuild_mcp_client(client: Any) -> Any | None:
        ...
        rebuild_info = getattr(client, "_gepaw_rebuild_info", None)
        ...
        try:
            if transport == "stdio":
                ...
                setattr(rebuilt_client, "_gepaw_rebuild_info", rebuild_info)
                return rebuilt_client
    ...
    def _set_formatter_media_strip(self, enabled: bool) -> None:
        ...
        if formatter is None:
            return
        setattr(formatter, "_gepaw_force_strip_media", enabled)
