...
1. ``evacuating_old``: move existing children into ``.gepaw_restore_old``.
...
OLD_CONTENT_DIR_NAME = ".gepaw_restore_old"
STATE_FILE_NAME = ".gepaw_restore_state"
STATE_TMP_FILE_NAME = ".gepaw_restore_state.tmp"
