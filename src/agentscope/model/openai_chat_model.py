...
class OpenAIChatModel(ChatModelBase):
    ...
    The real agentscope library wires streaming, function-calling, and
    format adaptation.  For gepaw tests, we only need the symbol to
    exist and to be importable.
    """
