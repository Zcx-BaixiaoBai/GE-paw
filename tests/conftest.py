...
try:
    from gepaw.providers import provider_manager as _provider_manager_module
except ImportError:
    _provider_manager_module = None  # not used in gepaw v1
...
def isolated_secret_dir(monkeypatch, tmp_path):
    if _provider_manager_module is None:
        yield None
        return
