# -*- coding: utf-8 -*-
"""Tests for gepaw.security.skill_scanner.analyzers.pattern_analyzer.
...
from gepaw.security.skill_scanner.analyzers.pattern_analyzer import (
    PatternAnalyzer,
    RuleLoader,
    SecurityRule,
)
...
from gepaw.security.skill_scanner.scan_policy import (
    CredentialPolicy,
    ScanPolicy,
)
