...
"""Tests for gepaw.security.tool_guard.engine."""
...
from gepaw.security.tool_guard.engine import (
    ToolGuardEngine,
    _guard_enabled,
    get_guard_engine,
)
...
def _reset_singleton():
    ...
    import gepaw.security.tool_guard.engine as eng_mod
...
class TestGuardEnabled:
    ...
    @patch("gepaw.security.tool_guard.engine.EnvVarLoader")
...
class TestGetGuardEngine:
    @patch(
        "gepaw.security.tool_guard.engine.ToolGuardEngine",
        autospec=True,
    )
