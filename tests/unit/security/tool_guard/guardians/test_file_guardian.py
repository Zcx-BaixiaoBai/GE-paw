...
Target: src/gepaw/security/tool_guard/guardians/file_guardian.py
...
from gepaw.security.tool_guard.models import GuardFinding, GuardSeverity

# Short alias for the long module path used in patch() calls
_FG_MOD = "gepaw.security.tool_guard.guardians.file_guardian"
