...
from gepaw.agents import model_factory
from gepaw.constant import MEDIA_UNSUPPORTED_PLACEHOLDER
...
def test_force_strip_media_flag_overrides_multimodal_support(
    ...
    """Test that _gepaw_force_strip_media flag forces media stripping."""
    monkeypatch.setattr(
        model_factory,
        "_supports_multimodal_for_current_model",
    ...
    original = _media_messages()
    formatter_instance = SimpleNamespace(_gepaw_force_strip_media=True)
...
def test_original_messages_not_modified_by_formatter_prep() -> None:
    ...
    (
        ...
        [original],
        OpenAIChatFormatter,
        SimpleNamespace(_gepaw_force_strip_media=False),
    )
