# -*- coding: utf-8 -*-
"""Tests for gepaw.agents.tools.view_media.
...
from gepaw.agents.tools.view_media import (
    _IMAGE_EXTENSIONS,
    _VIDEO_EXTENSIONS,
    _check_multimodal_support,
    _get_multimodal_fallback_hint,
...
class TestCheckMultimodalSupport:
    ...
    @patch("gepaw.agents.prompt._get_active_model_info", create=True)
...
class TestGetMultimodalFallbackHint:
    ...
    @patch(
        "gepaw.agents.prompt.get_active_model_multimodal_raw",
        create=True,
    )
...
class TestViewImage:
    ...
    @pytest.mark.asyncio
    @patch("gepaw.agents.tools.view_media._check_multimodal_support")
    ...
    @pytest.mark.asyncio
    @patch("gepaw.agents.tools.view_media._probe_multimodal_if_needed")
    @patch("gepaw.agents.tools.view_media._check_multimodal_support")
