# -*- coding: utf-8 -*-
"""Tests for gepaw.agents.tools.shell.
...
from gepaw.agents.tools.shell import (
    _collapse_embedded_newlines,
    _collapse_newlines_outside_quotes,
    _extract_powershell_command,
    _is_cmd,
...
class TestCollapseEmbeddedNewlines:
    ...
    @patch("gepaw.agents.tools.shell.sys")
...
class TestExecuteShellCommand:
    ...
    @pytest.mark.asyncio
    @patch("gepaw.agents.tools.shell.get_current_shell_command_timeout")
    @patch("gepaw.agents.tools.shell.get_current_workspace_dir")
    @patch("gepaw.agents.tools.shell.get_current_shell_command_executable")
    async def test_simple_command_success(
        ...
        with patch(
            "gepaw.agents.tools.shell.asyncio.create_subprocess_shell",
            AsyncMock(return_value=mock_proc),
        ), patch(
            "gepaw.agents.tools.shell.asyncio.wait_for",
