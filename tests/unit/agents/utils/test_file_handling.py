# -*- coding: utf-8 -*-
"""Tests for gepaw.agents.utils.file_handling.
...
from gepaw.agents.utils.file_handling import (
    _default_download_dir,
    _guess_suffix_from_file_content,
    _resolve_local_path,
    download_file_from_base64,
...
class TestDefaultDownloadDir:
    ...
    @patch("gepaw.agents.utils.file_handling.get_current_workspace_dir")
...
class TestDownloadFileFromUrl:
    ...
    @pytest.mark.asyncio
    @patch(
        "gepaw.agents.utils.file_handling._download_remote_to_path",
    )
