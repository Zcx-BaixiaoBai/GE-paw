# -*- coding: utf-8 -*-
"""Tests for gepaw.agents.utils.audio_transcription.
...
from gepaw.agents.utils.audio_transcription import (
    _get_configured_provider_creds,
    _get_manager,
    _url_for_provider,
    check_local_whisper_available,
...
from gepaw.providers.ollama_provider import OllamaProvider
from gepaw.providers.openai_provider import OpenAIProvider

_MOD = "gepaw.agents.utils.audio_transcription"
...
class TestGetManager:
    ...
    def test_returns_instance(self):
        ...
        with patch(
            "gepaw.providers.provider_manager.ProviderManager.get_instance",
    ...
    def test_import_failure_returns_none(self):
        with patch.dict(
            "sys.modules",
            {"gepaw.providers.provider_manager": None},
        ):
            _get_manager()
