# -*- coding: utf-8 -*-
"""Tests for gepaw.agents.tool_guard_mixin.
...
from gepaw.agents.tool_guard_mixin import (
    _GuardAction,
    _normalize_tool_guard_ui_lang,
    _tool_guard_t,
)
from gepaw.security.tool_guard.execution_level import ToolExecutionLevel
...
class TestEnsureToolGuard:
    ...
    @patch("gepaw.security.tool_guard.engine.get_guard_engine")
    @patch("gepaw.app.approvals.get_approval_service")
