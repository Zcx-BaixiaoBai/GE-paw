...
from gepaw.app.channels.matrix.channel import MatrixChannel
from gepaw.config.config import MatrixConfig
...
class TestMatrixChannelStartStop:
    ...
    async def test_start_creates_client(
        ...
        with patch(
            "gepaw.app.channels.matrix.channel.gepawMatrixClient",
