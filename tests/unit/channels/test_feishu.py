...
import pytest
from gepaw.app.channels.base import ContentType, OutgoingContentPart
...
def feishu_channel(
    ...
    from gepaw.app.channels.feishu.channel import FeishuChannel
...
class TestFeishuChannelFromConfig:
    ...
    def test_from_config_uses_config_values(self, mock_process_handler):
        ...
        from gepaw.app.channels.feishu.channel import FeishuChannel
        from gepaw.config.config import FeishuConfig
...
class TestFeishuChannelMessageDeduplication:
    ...
    def test_message_id_tracked(self, feishu_channel):
        ...
        from gepaw.app.channels.feishu.constants import (
...
class TestFeishuChannelFileUpload:
    ...
    async def test_upload_file_rejects_too_large(
        ...
        from gepaw.app.channels.feishu.constants import FEISHU_FILE_MAX_BYTES
...
class TestFeishuChannelDownloadImageResource:
    ...
    def mock_get_message_resource_request(self):
        ...
        with patch(
            "gepaw.app.channels.feishu.channel.GetMessageResourceRequest",
        ) as mock_class:
...
class TestFeishuChannelUploadImage:
    ...
    def mock_create_image_request(self):
        ...
        with (
            patch(
                "gepaw.app.channels.feishu.channel.CreateImageRequestBody",
            ) as mock_body_class,
            patch(
                "gepaw.app.channels.feishu.channel.CreateImageRequest",
...
class TestFeishuChannelUploadFile:
    ...
    def mock_create_file_request(self):
        ...
        with (
            patch(
                "gepaw.app.channels.feishu.channel.CreateFileRequestBody",
            ) as mock_body_class,
            patch(
                "gepaw.app.channels.feishu.channel.CreateFileRequest",
            ) as mock_request_class,
        ):
            mock_body_class.builder.return_value = mock_body_builder
            mock_request_class.builder.return_value = mock_request_builder
...
class TestFeishuChannelSendMessage:
    ...
    def mock_create_message_request(self):
        ...
        with (
            patch(
                "gepaw.app.channels.feishu.channel.CreateMessageRequestBody",
            ) as mock_body_class,
            patch(
                "gepaw.app.channels.feishu.channel.CreateMessageRequest",
            ) as mock_request_class,
        ):
            mock_body_class.builder.return_value = mock_body_builder
            mock_request_class.builder.return_value = mock_request_builder
...
class TestFeishuChannelThreadReply:
    ...
    def mock_reply_message_request(self):
        ...
        with (
            patch(
                "gepaw.app.channels.feishu.channel.ReplyMessageRequest",
            ) as mock_request_class,
            patch(
                "gepaw.app.channels.feishu.channel.ReplyMessageRequestBody",
            ) as mock_body_class,
        ):
...
class TestExtractInteractiveText:
    ...
    def test_extracts_title_and_elements(self):
        from gepaw.app.channels.feishu.utils import extract_interactive_text
