...
def yuanbao_channel(mock_process, tmp_path):
    ...
    from gepaw.app.channels.yuanbao.channel import YuanbaoChannel
...
def sample_upload_result():
    ...
    from gepaw.app.channels.yuanbao.media import UploadResult
...
class TestMediaHelpers:
    ...
    def test_guess_mime_jpeg(self):
        from gepaw.app.channels.yuanbao.media import _guess_mime
    ...
    def test_parse_image_size_png(self):
        from gepaw.app.channels.yuanbao.media import _parse_image_size
    ...
    def test_resolve_local_path_file_uri(self):
        from gepaw.app.channels.yuanbao.media import _resolve_local_path
...
class TestMediaMsgBody:
    ...
    def test_build_image_msg_body(self, sample_upload_result):
        from gepaw.app.channels.yuanbao.media import build_image_msg_body
    ...
    def test_build_file_msg_body(self):
        from gepaw.app.channels.yuanbao.media import (
            UploadResult,
            build_file_msg_body,
        )
...
class TestCosSignature:
    ...
    def test_sign_cos_request_format(self):
        from gepaw.app.channels.yuanbao.media import _sign_cos_request
...
class TestAuthSignature:
    ...
    def test_compute_signature(self):
        from gepaw.app.channels.yuanbao.auth import _compute_signature
...
class TestTokenManager:
    ...
    async def test_token_manager_init(self):
        from gepaw.app.channels.yuanbao.auth import TokenManager
    ...
    async def test_get_auth_headers(self):
        from gepaw.app.channels.yuanbao.auth import (
            SignTokenResult,
            TokenCache,
            TokenManager,
        )
...
class TestSendText:
    ...
    async def test_send_text_calls_ws(self, connected_channel):
        ...
        with patch(
            "gepaw.app.channels.yuanbao.channel.build_send_c2c_msg",
        ) as mock_build:
...
class TestSendMedia:
    ...
    async def test_send_media_part_upload_success(self, connected_channel):
        ...
        with patch(
            "gepaw.app.channels.yuanbao.channel.download_and_upload_media",
...
class TestCodecHelpers:
    ...
    def test_to_proto_msg_body_text(self):
        from gepaw.app.channels.yuanbao.codec import _to_proto_msg_body
    ...
    def test_from_proto_msg_body(self):
        from gepaw.app.channels.yuanbao.codec import _from_proto_msg_body
...
class TestHelperFunctions:
    ...
    def test_short_id_long_string(self):
        from gepaw.app.channels.yuanbao.channel import _short_id
...
class TestNormalizeInbound:
    ...
    def test_normalize_text_message(self):
        ...
        assert result["msg_body"][0]["msg_content"]["text"] == ""
...
class TestParseMsgBody:
    ...
    async def test_parse_image_elem(self, connected_channel):
        ...
        with patch(
            "gepaw.app.channels.yuanbao.channel.download_media",
            new_callable=AsyncMock,
            return_value=None,
        ), patch.object(
            connected_channel,
