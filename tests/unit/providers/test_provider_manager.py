...
import gepaw.providers.provider_manager as provider_manager_module
from gepaw.exceptions import ProviderError
from gepaw.providers.anthropic_provider import AnthropicProvider
...
from gepaw.local_models.llamacpp import LlamaCppServerSetupResult
...
def isolated_secret_dir(monkeypatch, tmp_path):
    secret_dir = tmp_path / ".gepaw.secret"
...
async def test_resume_local_model_restores_server_and_runtime_state(
    ...
    manager = ProviderManager()
    model_id = "AgentScope/gepaw-Flash-2B-Q4_K_M"
    ...
    provider = manager.get_provider("gepaw-local")
