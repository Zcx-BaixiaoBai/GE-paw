...
from gepaw.app.runner.manager import ChatManager
from gepaw.app.runner.models import ChatSpec, ChatUpdate
from gepaw.app.runner.repo.json_repo import JsonChatRepository
from gepaw.app.runner.title_generator import (
    MAX_TITLE_CHARS,
    _clean_title,
...
def _patch_model_factory(
    ...
    if factory_error is not None:
        return patch(
            "gepaw.agents.model_factory.create_model_and_formatter",
