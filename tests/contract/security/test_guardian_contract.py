...
from gepaw.security.tool_guard.guardians import BaseToolGuardian
from gepaw.security.tool_guard.guardians.file_guardian import (
    FilePathToolGuardian,
)
from gepaw.security.tool_guard.guardians.rule_guardian import (
    RuleBasedToolGuardian,
)
from gepaw.security.tool_guard.models import GuardFinding
...
def file_guardian():
    ...
    with patch(
        "gepaw.security.tool_guard.guardians.file_guardian"
...
def rule_guardian():
    ...
    with patch(
        "gepaw.security.tool_guard.guardians.rule_guardian"
        "._load_config_rules",
        return_value=([], set()),
    ), patch(
        "gepaw.security.tool_guard.guardians.rule_guardian"
